...
You can install terraform directlly in windows 10 by downloading the package supported for windows 10 directlly from terraform site but if you are pllanning to call the ansible code along with terraform code, we suggest to install Ubuntu as a sub system service in windows 10. Then install terraform and ansible in Ubuntu.   
